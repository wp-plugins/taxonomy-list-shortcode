...
`[taxonomy-list]` - Display a one column, unordered list of Post Tags. Although this is the default usage, it is synonymous with `[taxonomy-list tax="post_tag" cols="1"]`.

**Post Categories**

`[taxonomy-list tax='category']` - Display a one column, unordered list of Post Categories.

**Link Categories**

`[taxonomy-list tax='link_category']` - Display a one column, unordered list of Link Categories.

**Custom Taxonomy**

`[taxonomy-list tax="fishy-squiggles"]` - Display a one column, unordered list of the [custom taxonomy](http://justintadlock.com/archives/2009/05/06/custom-taxonomies-in-wordpress-28) "fishy-squiggles".
